...
~
	\smartdiagram[bubble diagram]{
        ...
        \textbf{~~Clean Archi~~},
        \textbf{~~IOT/BLE~~},
        \textbf{Coroutine}\\\textbf{~~Flow~~}
    }
}

% Programming skill bars
\programming{{C++ $\textbullet$ Swift $\textbullet$ Objective C  / 3.5}, {Java $\textbullet$ C\# $\textbullet$ Kotlin / 5}}

% Projects text
\projects{
\textbf{Projets YesItIs} CoverGarden, Sonde température, Revive Music,Applications toolbox\\ \\
